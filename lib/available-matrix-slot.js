...
const timeSlots = [
  {
    startTime: moment('2018-01-01T00:00:00.000Z').utc(),
    endTime: moment('2018-01-01T06:00:00.000Z').utc()
  },
  {
    startTime: moment('2018-01-01T06:00:00.000Z').utc(),
    endTime: moment('2018-01-01T12:00:00.000Z').utc()
  },
  {
    startTime: moment('2018-01-01T12:00:00.000Z').utc(),
    endTime: moment('2018-01-01T18:00:00.000Z').utc()
  },
  {
    startTime: moment('2018-01-01T18:00:00.000Z').utc(),
    endTime: moment('2018-01-01T23:59:59.000Z').utc()
  }
];
